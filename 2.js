...
function task2() {
  function promise1() {// Створюємо функцію promise1
  ...
  .then((result) => {
    ...
    .catch((error) => {
      ...
      .finally(() => {
        console.log("Завдання 2 завершено");});// Використовуємо Promise.race для визначення, який проміс виконується першим.
