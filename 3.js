...
function task3() {
  function promise1() {
    return new Promise((resolve)=>{
      setTimeout(()=>{
        resolve('Проміс 1 виконано');},1000);
      });
    }
  ...
  function promise2() {
    return new Promise((resolve, reject) => {
      ...
      }, 2000);});} // Створюємо функцію promise2, яка створює і повертає новий проміс, який відхиляється
  ...
  .then((results) => {
    results.forEach((result, index) => {
      if (result.status === 'fulfilled') {
        ...
        console.log(`Проміс ${index + 1} відхилено: ${result.reason}`);}});})// Використовуємо Promise.allSettled який приймає масив промісів і повертає новий проміс, який вирішується, коли всі проміси вирішено або відхилено
